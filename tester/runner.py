...
def safe_call_function(func: Any, inputs: List[Any], student_module=None) -> Dict[str, Any]:
...
def run_function_tests(func_name: str, func: Any, test_cases: List[Dict], 
                      student_module=None) -> Dict[str, Any]:
...
def run_tests(test_cases_file: str, 
              student_module_name: str, 
              function_points: Dict[str, int],
              assignment_name: str) -> Tuple[int, int]:
    """
    ...
    print(f"{grade_text} FINAL SCORE: {earned_points}/{total_points} points ({percentage:.1f}%) - {grade_text}")
    print("=" * 60)
...
def run_specific_functions(test_cases_file: str,
                          student_module_name: str,
                          function_names: List[str],
                          function_points: Dict[str, int]) -> Tuple[int, int]:
    """
