...
def create_scaled_identity_matrix(
    n: int, scalar: float
) -> np.ndarray:  # [MEDIUM] - 2 points
    """
...
def get_submatrix(
    arr: np.ndarray, rows: slice, cols: slice
