...
def euclidean_distance(point1: List[float], point2: List[float]) -> float:  # [EASY] - 2 points
    """
...
def manhattan_distance(point1: List[float], point2: List[float]) -> float:  # [EASY] - 2 points
    """
...
def minkowski_distance(point1: List[float], point2: List[float], p: float) -> float:  # [MEDIUM] - 3 points
    """
...
def find_k_nearest_neighbors(query_point: List[float], 
                           training_data: List[List[float]], 
                           training_labels: List[Any], 
                           k: int, 
                           distance_func: callable = euclidean_distance) -> List[Tuple[List[float], Any, float]]:  # [MEDIUM] - 4 points
    """
...
def find_neighbors_within_radius(query_point: List[float], 
                               training_data: List[List[float]], 
                               training_labels: List[Any], 
                               radius: float, 
                               distance_func: callable = euclidean_distance) -> List[Tuple[List[float], Any, float]]:  # [MEDIUM] - 3 points
    """
...
def weighted_majority_vote(neighbors: List[Tuple[List[float], Any, float]]) -> Any:  # [MEDIUM] - 3 points
    """
...
def knn_classify(query_point: List[float], 
                training_data: List[List[float]], 
                training_labels: List[Any], 
                k: int, 
                distance_func: callable = euclidean_distance, 
                weighted: bool = False) -> Any:  # [HARD] - 4 points
    """
...
def weighted_mean_prediction(neighbors: List[Tuple[List[float], float, float]]) -> float:  # [MEDIUM] - 3 points
    """
...
def knn_regress(query_point: List[float], 
               training_data: List[List[float]], 
               training_values: List[float], 
               k: int, 
               distance_func: callable = euclidean_distance, 
               weighted: bool = False) -> float:  # [HARD] - 4 points
    """
...
def train_test_split(data: List[List[float]], 
                    labels: List[Any], 
                    test_size: float = 0.2, 
                    random_seed: int = None) -> Tuple[List[List[float]], List[List[float]], List[Any], List[Any]]:  # [MEDIUM] - 3 points
    """
...
def calculate_accuracy(true_labels: List[Any], predicted_labels: List[Any]) -> float:  # [EASY] - 2 points
    """
...
def mean_squared_error(true_values: List[float], predicted_values: List[float]) -> float:  # [EASY] - 2 points
    """
...
def cross_validate_knn(data: List[List[float]], 
                      labels: List[Any], 
                      k_values: List[int], 
                      cv_folds: int = 5, 
                      distance_func: callable = euclidean_distance) -> List[Tuple[int, float]]:  # [HARD] - 5 points
    """
